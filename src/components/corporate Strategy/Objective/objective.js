...
import localclass from './objective.module.css';
    ...
    return (
        <div>
            <div className={localclass.main_container}>
                <div className={localclass.objective_section} >
                    <div className={localclass.objective_section_left}>
                        <div className={localclass.objective_section_uppertext}>
                            <h1>Objectives of our customer success programmes </h1>
                            <div className={localclass.objective_section_button}>
                                <button>Book Your Discovery Session</button>
                            </div>

                        </div>
                        <div className={localclass.objective_section_lowertext}>
                            <h1>Corporate success strategy </h1>
                            <p>Having a strong understanding of what the customer wants is crucial for a successful corporate level marketing strategy. Corporality formulates guidelines typically designed for the senior management level to be filtered down to all the employees across the organisation. There are crucial elements of corporate sustainability branding that help customers quickly identify and remember your company. With the right marketing mix, our experts cut through the noise to create directives to drop a product into the market.</p>
                        </div>
                    </div>
                    <div className={localclass.objective_section_right}>
                        <svg className={localclass.chart}></svg>
                    </div>
                </div>
            </div>
        </div>
