                    ...
                    <li className="about_li"><a href="#" className="nav-a">ABOUT</a>
                      ...
                      <div className="about-sub" id="abt-sub">
                        ...
                        <ul className="about-column-1">
                          ...
                          <li className="about_point2_li"><a href="https://corporality-about.web.app/about-corporality" className="about-point2">About
                            Corporality</a>
                            <img src="./img/nav/diamond_arrow.png" className="about-point2-img" />
                          </li>
                          <li className="about_point3_li"><a href="https://corporality-about.web.app/work-with-client" className="about-point3">How We Work
                            With Clients</a>
                            <img src="./img/nav/diamond_arrow.png" className="about-point3-img" />
                          </li>
                        </ul>
                        <ul className="about-column-2">
                          <li className="about_point4_li"><a href="https://corporality-about.web.app/sustainable-growth" className="about-point4">Sustainable
                            Growth</a>
