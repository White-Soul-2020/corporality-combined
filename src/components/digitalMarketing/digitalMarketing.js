          ...
          <div className="main-blueprint">
            <div className="main-container"> {/*main container div*/}
              ...
              <div className="blueprint-group-img text-center">
                ...
                <img src="./img/blueprint/circle.png" className="blueprint-img" data-aos="zoom-in" data-aos-duration="1500"/>
                <div className="blueprint-cards">
                <img src="./img/blueprint/blueprint-cards.png"  data-aos="zoom-in" data-aos-duration="3000"/>
                </div>
              </div>
            </div>{/*container div*/}
          </div>
